...
class RiskZonesMapScreen extends StatefulWidget {
  const RiskZonesMapScreen({super.key});

  @override
  State<RiskZonesMapScreen> createState() => _RiskZonesMapScreenState();
}

class _RiskZonesMapScreenState extends State<RiskZonesMapScreen> {
  ...
  void initState() {
    super.initState();
    // Initialize with Risk Zones API Key
    ArcGISService.initializeRiskZones();
  }
      ...
      body: Stack(
        children: [
          ...
          ArcGISMapView(
            ...
            onMapViewReady: () {
               final map = ArcGISService.getRiskZonesMap();
                          ...
                          child: ListView(
                            children: const [
                              ListTile(
                                ...
                                title: Text("Risk Zones Layer (Default)"),
                              ),
                              ListTile(
